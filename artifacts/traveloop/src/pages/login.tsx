    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 flex flex-col items-center justify-center bg-white px-6 py-12 sm:px-10 lg:px-16 xl:px-24">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-6 p-3 rounded-lg bg-cyan-50 border border-cyan-100">
            <p className="text-xs text-center text-cyan-700 font-medium">
              Demo: <span className="font-mono">alex@traveloop.com</span> · <span className="font-mono">password</span>
            </p>
          </div>
        </div>
